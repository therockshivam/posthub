...
import com.posthub.dto.request.auth.ResetPasswordRequest;
import com.posthub.dto.request.user.AbstractBaseCreateUserRequest;
import com.posthub.dto.request.user.AbstractBaseUpdateUserRequest;
import com.posthub.dto.request.user.CreateUserRequest;
import com.posthub.dto.request.user.UpdatePasswordRequest;
import com.posthub.dto.request.user.UpdateUserRequest;
import com.posthub.entity.User;
import com.posthub.entity.specification.UserFilterSpecification;
import com.posthub.entity.specification.criteria.PaginationCriteria;
import com.posthub.entity.specification.criteria.UserCriteria;
import com.posthub.event.UserEmailVerificationSendEvent;
import com.posthub.event.UserPasswordResetSendEvent;
...
import com.posthub.security.JwtUserDetails;
import com.posthub.util.Constants;
import com.posthub.util.PageRequestBuilder;
...
//        System.out.println("Password reset token: {}", user.getPasswordResetToken());
