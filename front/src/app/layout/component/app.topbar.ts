...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator,MenuModule,AvatarModule,ButtonModule],
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <button  type="button" class="layout-topbar-action">
                     ...
                     <button (click)="this.logout()" type="button" class="layout-topbar-action">
...
export class AppTopbar {
    ...
    constructor(public layoutService: LayoutService, private authService:AuthService, private router: Router, private globalService:GlobalService) {}
